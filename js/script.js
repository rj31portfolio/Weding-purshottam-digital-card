...
const INVITATION_CONFIG = Object.freeze({ brideName: 'Purushottam Kumar Sah', whatsappNumber: '' });
...
function updateWhatsApp() {
  ...
  const message = `Thank you for inviting me to the wedding celebrations of Purushottam Kumar Sah & ${brideName} on 27–28 November 2026. ${answer}`;
